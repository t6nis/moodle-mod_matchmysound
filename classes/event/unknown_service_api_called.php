...
/**
 * The mod_matchmysound unknown service api called event.
 *
...
namespace mod_matchmysound\event;
...
class unknown_service_api_called extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('matchmysoundunknownserviceapicall', 'mod_matchmysound');
    }
    ...
    public static function get_legacy_eventname() {
        return 'matchmysound_unknown_service_api_call';
    }
