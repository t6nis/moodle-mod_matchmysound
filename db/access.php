...
/**
 * This file contains the capabilities used by the matchmysound module
 *
...
$capabilities = array(
    ...
    'mod/matchmysound:addinstance' => array(
    ...
    // otherwise they are given Learner. See the matchmysound_get_ims_role function.
    'mod/matchmysound:manage' => array(
    ...
    'mod/matchmysound:addcoursetool' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
    ...
    'mod/matchmysound:requesttooladd' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
