...
experience.';
$string['accept_grades_help'] = 'Specify whether the tool provider can add, update, read, and delete grades associated only with this matchmysound instance.
...
$string['addtype'] = 'Add matchmysound configuration';
$string['allow'] = 'Allow';
...
$string['basicmatchmysound'] = 'MatchMySound';
$string['basicmatchmysound_base_string'] = 'MatchMySound OAuth base string';
$string['basicmatchmysound_endpoint'] = 'MatchMySound launch endpoint';
$string['basicmatchmysound_in_new_window'] = 'Your activity has opened in a new window';
$string['basicmatchmysound_parameters'] = 'MatchMySound launch parameters';
$string['basicmatchmysoundactivities'] = 'MatchMySound activities';
$string['basicmatchmysoundfieldset'] = 'Custom example fieldset';
$string['basicmatchmysoundintro'] = 'Activity description';
$string['basicmatchmysoundname'] = 'Activity name';
$string['basicmatchmysoundsettings'] = 'Basic Learning Tool Interoperability (MatchMySound) settings';
...
$string['configdebug'] = 'Show debugging messages';
...
$string['configtypes'] = 'Enable MatchMySound applications';
$string['course_tool_types'] = 'Course tool types';
$string['courseid'] = 'Course ID number';
$string['coursemisconf'] = 'Course is misconfigured';
$string['createdon'] = 'Created on';
$string['curllibrarymissing'] = 'PHP Curl library must be installed to use MatchMySound';
...
$string['delete_confirmation'] = 'Are you sure you want to delete this matchmysound configuration?';
$string['deletetype'] = 'Delete matchmysound configuration';
...
$string['edittype'] = 'Edit matchmysound configuration';
$string['embed'] = 'Embed';
...
$string['external_tool_type'] = 'MatchMySound type';
...
* **A specific tool type** - By selecting a specific tool type, you can force Moodle to use that tool configuration when communicating with the
       matchmysound provider. If the Launch URL does not appear to belong to the tool provider, a warning will appear. In some cases, it is not necessary
...
Three icons are available after the MatchMySound type dropdown list:
...
$string['external_tool_types'] = 'MatchMySound types';
$string['failedtoconnect'] = 'Moodle was unable to communicate with the "{$a}" system';
$string['filter_basicmatchmysound_configlink'] = 'Configure your preferred sites and their passwords';
$string['filter_basicmatchmysound_password'] = 'Password is mandatory';
$string['filterconfig'] = 'MatchMySound administration';
$string['filtername'] = 'MatchMySound';
...
MatchMySound icon, an icon which conveys the type of activity may be specified.';
$string['id'] = 'id';
$string['invalidid'] = 'MatchMySound ID was incorrect';
...
$string['matchmysound'] = 'MatchMySound';
$string['matchmysound:addinstance'] = 'Add new matchmysound activities';
$string['matchmysound:addcoursetool'] = 'Add course-specific tool configurations';
$string['matchmysound:grade'] = 'View grades returned by the matchmysound';
$string['matchmysound:manage'] = 'Be an Instructor when the tool is launched';
$string['matchmysound:requesttooladd'] = 'Request a tool is configured site-wide';
$string['matchmysound:view'] = 'Launch matchmysound activities';
$string['matchmysound_administration'] = 'MatchMySound administration';
$string['matchmysound_errormsg'] = 'The tool returned the following error message: "{$a}"';
$string['matchmysound_launch_error'] = 'An error occurred when launching the matchmysound:';
$string['matchmysound_launch_error_tool_request'] = '<p>
...
$string['matchmysound_launch_error_unsigned_help'] = '<p>This error may be a result of a missing consumer key and shared secret for the tool provider.</p>
<p>If you have a consumer key and shared secret, you may enter it when editing the matchmysound instance (make sure advanced options are visible).</p>
<p>Alternatively, you may <a href="{$a->course_tool_editor}">create a course level tool provider configuration</a>.</p>';
$string['matchmysound_tool_request_added'] = 'Tool configuration request successfully submitted. You may need to contact an administrator to complete the tool configuration.';
$string['matchmysound_tool_request_existing'] = 'A tool configuration for the tool domain has already been submitted.';
$string['matchmysoundunknownserviceapicall'] = 'MatchMySound unknown service API call.';
$string['main_admin'] = 'General help';
$string['main_admin_help'] = 'MatchMySounds allow Moodle users to seamlessly interact with learning resources hosted remotely. Through a special
...
$string['modulename'] = 'MatchMySound';
$string['modulename_help'] = 'The matchmysound activity module enables students to interact with learning resources and activities on other web sites. For example, an matchmysound could provide access to a new activity type or learning materials from a publisher.

To create an matchmysound activity, a tool provider which supports MatchMySound (Learning Tools Interoperability) is required. A teacher can create an matchmysound activity or make use of a tool configured by the site administrator.

MatchMySound activities differ from URL resources in a few ways:

* MatchMySounds are context aware i.e. they have access to information about the user who launched the tool, such as institution, course and name
* MatchMySounds support reading, updating, and deleting grades associated with the activity instance
* MatchMySound configurations create a trust relationship between your site and the tool provider, allowing secure communication between them';
$string['modulename_link'] = 'mod/matchmysound/view';
$string['modulenameplural'] = 'MatchMySounds';
$string['modulenamepluralformatted'] = 'MatchMySound Instances';
$string['never'] = 'Never';
$string['new_window'] = 'New window';
$string['no_matchmysound_configured'] = 'There are no active matchmysounds configured.';
$string['no_matchmysound_pending'] = 'There are no pending matchmysounds.';
$string['no_matchmysound_rejected'] = 'There are no rejected matchmysounds.';
$string['noattempts'] = 'No attempts have been made on this tool instance';
$string['nomatchmysounds'] = 'There are no matchmysound instances';
$string['noservers'] = 'No servers found';
$string['notypes'] = 'There are currently no MatchMySound tools set up in Moodle. Click the Install link above to add some.';
...
$string['pluginadministration'] = 'MatchMySound administration';
$string['pluginname'] = 'MatchMySound';
...
$string['quickgrade_help'] = 'If enabled, mumatchmysoundple tools can be graded on one page. Add grades and comments then click the "Save all my feedback" button to save all changes for that page.';
...
$string['show_in_course_help'] = 'If selected, this tool configuration will appear in the "MatchMySound type" dropdown when teachers
configure matchmysounds within courses.
...
$string['toolsetup'] = 'MatchMySound configuration';
...
to teachers when adding matchmysounds within courses.';
$string['types'] = 'Types';
