...
$review = optional_param('review', 0, PARAM_INT); // Optioanl student to review ID
...
require_capability('mod/matchmysound:view', $context);

$matchmysound->cmid = $cm->id;
if ($review > 0) {
   matchmysound_view($matchmysound, $review); 
} else {
   matchmysound_view($matchmysound);
}
